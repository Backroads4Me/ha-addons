...
* **The LibreCoach Add-on**: This is the *installer*. You run it once to automatically set up the environment.
* **The LibreCoach App**: This is the *result*. It is the complete system (Dashboards, Automation, Logic) that controls your rig.
